...
export function AboutSection() {
  ...
  // Values are server-rendered as final text; the count-up only runs on the
  // client, once in view, and never under reduced motion.
  useGSAP(
    () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            <div className="relative">
              <span aria-hidden="true" className="absolute -top-16 -left-4 font-serif text-[180px] leading-none text-whisper select-none pointer-events-none">
                02
              </span>
            </div>
            ...
            <SlideIn direction="left">
              <div className="space-y-6 relative">
                <p className="text-sm text-ash font-mono leading-[1.8]">
              ...
              <div className="flex items-start gap-6 md:gap-8 pt-6 border-t border-iron">
                {stats.map((stat) => (
                  <div key={stat.label} className="text-center">
                    <div
                      className={`stat-number font-serif text-4xl tabular-nums ${
                    ...
                    <div className="text-[10px] font-mono uppercase tracking-[0.2em] text-steel mt-1">
                      {stat.label}
                    </div>
                  </div>
                ))}
          ...
          <div className="lg:col-span-7">
            <SlideIn direction="right">
              ...
              <p className="text-xs font-mono text-steel italic mt-4">
